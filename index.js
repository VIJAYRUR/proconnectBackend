...
app.use((req, res, next) => {
  const allowedOrigins = ['http://localhost:3000', 'https://proconnect-frontend-be92.vercel.app','https://proconnect-frontend-i41l-fuqasil3p-vijayrur.vercel.app','https://proconnect-frontend.vercel.app'];
